        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p
              ...
              data-aos-duration="1500"
            >
              I'm a information technology student. I am passionate about
              creating digital experiences that are enjoyable and always strive
              to provide the best solution in each project.
            </p>
